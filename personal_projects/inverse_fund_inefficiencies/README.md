While experimenting with both overnight returns and the hedging algorithms, I noticed that long and inverse fund returns tend to diverge. Above is a script that demonstrates this, but make sure to make the necessary changes everywhere in the code if changing the list of assets. 
</br>
</br>
